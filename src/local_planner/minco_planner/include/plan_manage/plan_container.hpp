...
struct LocalTrajData {
  ...
  // Commanded trajectory. With backup enabled this is:
  // exploration prefix + backup trajectory.
  Trajectory<7> minco_traj_;
  Trajectory<5> minco_yaw_traj_;

  // Latest optimized exploration trajectory before commitment.
  Trajectory<7> exp_traj_;
  Trajectory<5> exp_yaw_traj_;

  // Safety fallback appended to the committed command.
